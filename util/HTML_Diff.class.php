...
class HTML_Diff
{
  ...
  public static function htmlDiff($expected, $obtained): String
  {
    // renderer class name:
    ...
    $jsonResult = DiffHelper::calculate($expected, $obtained, 'Json'); // may store the JSON result in your database
